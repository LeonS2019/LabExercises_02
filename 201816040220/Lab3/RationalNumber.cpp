...
/* Write definition for overloaded operator + */
 ...
 {
     RationalNumber a;
     a.numerator=numerator*right.denominator+denominator*right.numerator;
     a.denominator=denominator*right.denominator;
     a.reduction();
     return a;
 }
// overloaded - operator
...
/* Write definition for overloaded operator * */
 ...
 {
     RationalNumber a;
     a.numerator=numerator*right.numerator;
     a.denominator=denominator*right.denominator;
     a.reduction();
     return a;
 }
...
/* Write definition for overloaded operator /. Check if the client is
 ...
 {
     RationalNumber a;
     a.numerator=numerator*right.denominator;
     a.denominator=denominator*right.numerator;
     a.reduction();
     return a;
 }
// overloaded > operator
