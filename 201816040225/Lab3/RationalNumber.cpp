...
{
    //RationalNumber r;
  int numerator1=numerator*Rational.denominator+denominator*Rational.numerator;
  int denominator1=denominator*Rational.denominator;
  return RationalNumber(numerator1,denominator1);
}
// overloaded - operator
/* Write definition for overloaded operator - */
RationalNumber RationalNumber::operator-(RationalNumber &Rational)
...
RationalNumber RationalNumber::operator*(RationalNumber &Rational)
{
   int numerator1=numerator*Rational.numerator;
   int denominator1=denominator*Rational.denominator;
   return RationalNumber(numerator1,denominator1);
}
// overloaded / operator
...
RationalNumber RationalNumber::operator/(RationalNumber &Rational)
{
   int numerator1=numerator*Rational.denominator;
   int denominator1=denominator*Rational.numerator;
   return RationalNumber(numerator1,denominator1);
}
// overloaded > operator
/* Write definition for operator > */
bool RationalNumber::operator>(RationalNumber &Rational)
{
    int numerator1=numerator*Rational.denominator;
    int denominator1=denominator*Rational.numerator;
