...
HugeInt HugeInt::operator+( const char *op2 ) const
{
 ...
 HugeInt HugeInt::operator-( int op2 ) const//sub function int
{
   // convert op2 to a HugeInt, then invoke
   // operator-for two HugeInt objects
   return *this + HugeInt( op2 );
} // end function operator+
HugeInt HugeInt::operator-( const char *op2 ) const//sub function char *
{
   // convert op2 to a HugeInt, then invoke
   // operator- for two HugeInt objects
   return *this + HugeInt( op2 );
...
bool HugeInt::operator==( const HugeInt &a)//judge
{
    for ( int i = 29; i >= 0; i-- )
   {
