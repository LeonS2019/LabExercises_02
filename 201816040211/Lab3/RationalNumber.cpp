...
{
    RationalNumber h;
    h.denominator=denominator*right.denominator;
    h.numerator=numerator*right.denominator+denominator*right.numerator;
    h.reduction();
    return h;
}// 加法的实现
...
RationalNumber RationalNumber::operator * (RationalNumber &right)
{
    RationalNumber h;
    h.denominator=denominator*right.denominator;
    h.numerator=numerator*right.numerator;
    h.reduction();
    return h;
}//乘法的实现
...
{
    RationalNumber h;
    h.denominator=denominator*right.numerator;
    h.numerator=numerator*right.denominator;
    h.reduction();
    return h;
}//除法的实现
// overloaded > operator
...
bool RationalNumber::operator > (RationalNumber &right)
{
    ...
    b=right.numerator/right.denominator;
    if(a>b)
    {
        return true;
    }
