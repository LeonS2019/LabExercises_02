...
const String String::operator+(const String &right)/* Write the header for the operator+ member function */
{
   ...
   temp.length=length+right.length;/* Set temp length to be the sum of the two argument Strings?lengthes */
   ...
   strcat( temp.sPtr, right.sPtr );/* Write a call to strcat to concatenate the string in right onto the end of the string in temp */
