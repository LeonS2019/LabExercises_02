...
{
    RationalNumber t;
    t.denominator = denominator * right.denominator;
    t.numerator = numerator * right.denominator + denominator * right.numerator;
    t.reduction();
    return t;
}
...
{
    RationalNumber t;
    t.numerator = numerator * right.numerator;
    t.denominator = denominator * right.denominator;
    t.reduction();
    return b;
}/* Write definition for overloaded operator * */
...
{
    RationalNumber t;
    t.numerator = numerator * right.denominator;
    t.denominator = denominator * right.numerator;
    t.reduction();
    return t;
...
{
    if( numerator*right.denominator > denominator*right.numerator ) const
        return 1;
    else
        return 0;
