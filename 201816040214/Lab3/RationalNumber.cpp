...
RationalNumber RationalNumber::operator/ (const RationalNumber &op2) const
{
    ...
    if(op2.numerator <= 0)
    {
        throw invalid_argument("denominator is 0, error!");
    }
    else
    {
...
bool RationalNumber::operator>= (const RationalNumber &op2) const
{
    ...
    {
        if(numerator*op2.denominator > op2.numerator*denominator || numerator*op2.denominator == op2.numerator*denominator)
            return true;
        else
            return false;
    }
